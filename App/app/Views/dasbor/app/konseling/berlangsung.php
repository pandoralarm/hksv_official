  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sesi Konseling Berlangsung</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Sesi Konseling</a></li>
      ...
      <div class="container-fluid">
        ...
        <script>
          $(function () {
            ...
            axios.get("https://halokonselingsv.ipb.ac.id/dasbor/app/getOpenThread")
            ...
            setTimeout(() => {
              ...
              $("#jsGrid1").jsGrid({
                  ...
                  fields: [
                      { name: "KonselorNIP", type: "text", title: "Konselor", width: 150},
                      { name: "MahasiswaNIM", type: "text", title: "Konseli",  width: 80},
                      { name: "Started_at", type: "text", title: "Mulai",  width: 150},
                      { name: "ThreadKey", type: "text", title: "Aksi",  width: 50}
                  ]
              });
            }, 500);
            ...
            setTimeout(() => {
              $("#jsGrid2").jsGrid({
                ...
                fields: [
                    { name: "MahasiswaNIM", type: "text", title: "Konseli", width: 150 },
                    { name: "ThreadKey", type: "text", title: "Aksi",  width: 50}
                ]
            });
            }, 500);
